...
/**
 * @file Recipe input / output replacements for Valhelsia 7.
 * 
...
ServerEvents.recipes(event => {
  ...
  //replaceInput('forbidden_arcanus:deorum_ingot', '#c:ingots/deorum');
  //replaceInput('forbidden_arcanus:obsidiansteel_ingot', '#forge:ingots/obsidian');
  ...
  replaceInput('mekanism:dust_obsidian', '#c:dusts/obsidian');
  ...
  //replaceInput('alexsmobs:fish_bones', '#c:bones/fish');
  ...
  replaceInput('biomesoplenty:rose_quartz_chunk', '#valhelsia:rose_quartz');
  ...
  replaceInput('minecraft:ender_pearl', '#c:ender_pearls');
  ...
  replaceInputID('waystones:warp_dust', 'minecraft:ender_pearl', '#c:dusts/ender_pearl');
  ...
  replaceInputID('ars_nouveau:warp_scroll', 'minecraft:lapis_lazuli', '#c:dusts/warp'); // Now even warpier!
});
